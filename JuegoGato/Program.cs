...
namespace JuegoGato
{
    ...
    {
        // Crea un arreglo bidimensional para el tablero del juego
        static int[,] tablero = new int[3, 3]; // 3 filas - 3 columnas
        // Crea un arreglo para los símbolos del tablero: Espacio en blanco, jug.1, jug.2
        ...
        static void Main(string[] args)
        {
            ...
            do /* Usa un ciclo do-while porque se desconoce el número de veces que se tiene que llevar a cabo */
            {
                // Turno Jugador 1
                ...
                else // De lo contrario se comprueba si hubo un empate
                {
        ...
        static bool ComprobarEmpate()
        {
            ...
            return !hayEspacio; /*Si el ciclo anterior nos regresa un "true", indicando que sí hay espacios, entonces se tiene que regresar una negación de true para que la condición de empate no se cumpla en la función de Main()*/
